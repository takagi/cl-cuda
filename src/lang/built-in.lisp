...
(defparameter +built-in-functions+
  '(;; arithmetic operators
    ...
    * (((int    int)    int    t   "*")
    ...
    asin  (((float) float nil "asinf")
           ((double) double nil "asin"))
    acos  (((float) float nil "acosf")
           ((double) double nil "acos"))
    atan  (((float) float nil "atanf")
           ((float float) float nil "atan2f")
           ((double) double nil "atan")
           ((double double) double nil "atan2"))
    ...
    asinh  (((float) float nil "asinhf")
           ((double) double nil "asinh"))
    acosh  (((float) float nil "acoshf")
           ((double) double nil "acosh"))
    atanh  (((float) float nil "atanhf")
           ((double) double nil "atanh"))
