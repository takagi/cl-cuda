...
(is (cl-cuda.api::kernel-arg-names '((x cl-cuda:int) (y cl-cuda:float3) (a cl-cuda:float3*))) '(x y a))

;; test kernel-arg-non-array-args
(is (cl-cuda.api::kernel-arg-non-array-args '((x cl-cuda:int) (y cl-cuda:float3) (a cl-cuda:float3*)))
                                        '((x cl-cuda:int) (y cl-cuda:float3)))

;; test kernel-arg-array-args
(is (cl-cuda.api::kernel-arg-array-args '((x cl-cuda:int) (y cl-cuda:float3) (a cl-cuda:float3*)))
                                    '((a cl-cuda:float3*)))

;; test kernel-arg-ptr-type-binding
(is (cl-cuda.api::kernel-arg-ptr-type-binding '(x cl-cuda:int))    '(x-ptr :int))
(is (cl-cuda.api::kernel-arg-ptr-type-binding '(x cl-cuda:float3)) '(x-ptr '(:struct float3)))

;; test kernel-arg-ptr-type-binding
(is (cl-cuda.api::kernel-arg-ptr-var-binding '(a cl-cuda:float3*)) '(a-ptr a))
