...
(is (cl-cuda.lang::cffi-type 'float* ) 'cl-cuda.lang::cu-device-ptr)
(is (cl-cuda.lang::cffi-type 'float3*) 'cl-cuda.lang::cu-device-ptr)
(is (cl-cuda.lang::cffi-type 'float4*) 'cl-cuda.lang::cu-device-ptr)
...
;; test vector-types
(is (cl-cuda.lang::vector-types) '(float3 float4))
...
(is       (cl-cuda.lang::array-type-pointer-size 'float* ) 4)
(is       (cl-cuda.lang::array-type-pointer-size 'float3*) 4)
(is       (cl-cuda.lang::array-type-pointer-size 'float4*) 4)
...
(is (cl-cuda.lang::literal-p 1.0d0) nil)
...
(is-error (cl-cuda.lang::compile-literal 1.0d0) simple-error)
...
(is-error (cl-cuda.lang::type-of-literal '1.0d0) simple-error)
