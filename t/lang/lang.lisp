...
;; test type-size
(is (cl-cuda.lang::type-size 'void  ) 0 )
(is (cl-cuda.lang::type-size 'bool  ) 1 )
(is (cl-cuda.lang::type-size 'int   ) 4 )
(is (cl-cuda.lang::type-size 'float ) 4 )
(is (cl-cuda.lang::type-size 'float3) 12)
(is (cl-cuda.lang::type-size 'float4) 16)
(is (cl-cuda.lang::type-size 'double) 8 )
(is (cl-cuda.lang::type-size 'double3) 24)
(is (cl-cuda.lang::type-size 'double4) 32)
(is (cl-cuda.lang::type-size 'int*  )
    (cffi:foreign-type-size 'cl-cuda.driver-api:cu-device-ptr))
(is (cl-cuda.lang::type-size 'int** )
...
;; test valid-type-p
(is (cl-cuda.lang::valid-type-p 'void    ) t  )
(is (cl-cuda.lang::valid-type-p 'bool    ) t  )
(is (cl-cuda.lang::valid-type-p 'int     ) t  )
(is (cl-cuda.lang::valid-type-p 'float   ) t  )
(is (cl-cuda.lang::valid-type-p 'float3  ) t  )
(is (cl-cuda.lang::valid-type-p 'float4  ) t  )
(is (cl-cuda.lang::valid-type-p 'float*  ) t  )
(is (cl-cuda.lang::valid-type-p 'float** ) t  )
(is (cl-cuda.lang::valid-type-p '*float**) nil)
(is (cl-cuda.lang::valid-type-p 'double3  ) t  )
(is (cl-cuda.lang::valid-type-p 'double4  ) t  )
(is (cl-cuda.lang::valid-type-p 'double*  ) t  )
(is (cl-cuda.lang::valid-type-p 'double** ) t  )
(is (cl-cuda.lang::valid-type-p '*double**) nil)

;; test cffi-type
(is (cl-cuda.lang::cffi-type 'void   ) :void                  )
(is (cl-cuda.lang::cffi-type 'bool   ) '(:boolean :int8)      )
(is (cl-cuda.lang::cffi-type 'int    ) :int                   )
(is (cl-cuda.lang::cffi-type 'float  ) :float                 )
(is (cl-cuda.lang::cffi-type 'float3 ) '(:struct float3)      )
(is (cl-cuda.lang::cffi-type 'float4 ) '(:struct float4)      )
(is (cl-cuda.lang::cffi-type 'float* ) 'cu-device-ptr)
(is (cl-cuda.lang::cffi-type 'float3*) 'cu-device-ptr)
(is (cl-cuda.lang::cffi-type 'float4*) 'cu-device-ptr)
(is (cl-cuda.lang::cffi-type 'double  ) :double                 )
(is (cl-cuda.lang::cffi-type 'double3 ) '(:struct double3)      )
(is (cl-cuda.lang::cffi-type 'double4 ) '(:struct double4)      )
(is (cl-cuda.lang::cffi-type 'double* ) 'cu-device-ptr)
(is (cl-cuda.lang::cffi-type 'double3*) 'cu-device-ptr)
(is (cl-cuda.lang::cffi-type 'double4*) 'cu-device-ptr)

;; test non-pointer-type-p
(is (cl-cuda.lang::non-pointer-type-p 'float   ) t  )
(is (cl-cuda.lang::non-pointer-type-p 'float*  ) nil)
(is (cl-cuda.lang::non-pointer-type-p 'float3* ) nil)
(is (cl-cuda.lang::non-pointer-type-p 'float4* ) nil)
(is (cl-cuda.lang::non-pointer-type-p '*float3*) nil)
(is (cl-cuda.lang::non-pointer-type-p 'double   ) t  )
(is (cl-cuda.lang::non-pointer-type-p 'double*  ) nil)
(is (cl-cuda.lang::non-pointer-type-p 'double3* ) nil)
(is (cl-cuda.lang::non-pointer-type-p 'double4* ) nil)
(is (cl-cuda.lang::non-pointer-type-p '*double3*) nil)

;; test basic-type-size
(is       (cl-cuda.lang::basic-type-size 'void  ) 0           )
(is       (cl-cuda.lang::basic-type-size 'bool  ) 1           )
(is       (cl-cuda.lang::basic-type-size 'int   ) 4           )
(is       (cl-cuda.lang::basic-type-size 'float ) 4           )
(is-error (cl-cuda.lang::basic-type-size 'float3) simple-error)
(is-error (cl-cuda.lang::basic-type-size 'float3) simple-error)
(is       (cl-cuda.lang::basic-type-size 'double ) 8           )
(is-error (cl-cuda.lang::basic-type-size 'double3) simple-error)
(is-error (cl-cuda.lang::basic-type-size 'double3) simple-error)

;; test basic-type-p
(is (cl-cuda.lang::basic-type-p 'void  ) t  )
(is (cl-cuda.lang::basic-type-p 'bool  ) t  )
(is (cl-cuda.lang::basic-type-p 'int   ) t  )
(is (cl-cuda.lang::basic-type-p 'float ) t  )
(is (cl-cuda.lang::basic-type-p 'float3) nil)
(is (cl-cuda.lang::basic-type-p 'float*) nil)
(is (cl-cuda.lang::basic-type-p 'double ) t  )
(is (cl-cuda.lang::basic-type-p 'double3) nil)
(is (cl-cuda.lang::basic-type-p 'double*) nil)

;; test basic-cffi-type
(is       (cl-cuda.lang::basic-cffi-type 'void  ) :void            )
(is       (cl-cuda.lang::basic-cffi-type 'bool  ) '(:boolean :int8))
(is       (cl-cuda.lang::basic-cffi-type 'int   ) :int             )
(is       (cl-cuda.lang::basic-cffi-type 'float ) :float           )
(is-error (cl-cuda.lang::basic-cffi-type 'float3) simple-error     )
(is-error (cl-cuda.lang::basic-cffi-type 'float*) simple-error     )
(is       (cl-cuda.lang::basic-cffi-type 'double ) :double           )
(is-error (cl-cuda.lang::basic-cffi-type 'double3) simple-error     )
(is-error (cl-cuda.lang::basic-cffi-type 'double*) simple-error     )

;; test vector-type-size
(is       (cl-cuda.lang::vector-type-size 'float3) 12          )
(is       (cl-cuda.lang::vector-type-size 'float4) 16          )
(is-error (cl-cuda.lang::vector-type-size 'float ) simple-error)
(is       (cl-cuda.lang::vector-type-size 'double3) 24         )
(is       (cl-cuda.lang::vector-type-size 'double4) 32         )
(is-error (cl-cuda.lang::vector-type-size 'double ) simple-error)
(is-error (cl-cuda.lang::vector-type-size 'int*  ) simple-error)

;; test vector-type-p
(is (cl-cuda.lang::vector-type-p 'float3) t  )
(is (cl-cuda.lang::vector-type-p 'float4) t  )
(is (cl-cuda.lang::vector-type-p 'float ) nil)
(is (cl-cuda.lang::vector-type-p 'float*) nil)
(is (cl-cuda.lang::vector-type-p 'double3) t  )
(is (cl-cuda.lang::vector-type-p 'double4) t  )
(is (cl-cuda.lang::vector-type-p 'double ) nil)
(is (cl-cuda.lang::vector-type-p 'double*) nil)

;; test vector-cffi-type
(is       (cl-cuda.lang::vector-cffi-type 'float3) '(:struct float3))
(is       (cl-cuda.lang::vector-cffi-type 'float4) '(:struct float4))
(is-error (cl-cuda.lang::vector-cffi-type 'float ) simple-error     )
(is-error (cl-cuda.lang::vector-cffi-type 'float*) simple-error     )
(is       (cl-cuda.lang::vector-cffi-type 'double3) '(:struct double3))
(is       (cl-cuda.lang::vector-cffi-type 'double4) '(:struct double4))
(is-error (cl-cuda.lang::vector-cffi-type 'double ) simple-error     )
(is-error (cl-cuda.lang::vector-cffi-type 'double*) simple-error     )

;; test vector-types
(is (cl-cuda.lang::vector-types) '(float3 float4 double3 double4))

;; test vector-type-base-type
(is       (cl-cuda.lang::vector-type-base-type 'float3 ) 'float      )
(is-error (cl-cuda.lang::vector-type-base-type 'float  ) simple-error)
(is-error (cl-cuda.lang::vector-type-base-type 'float3*) simple-error)
(is       (cl-cuda.lang::vector-type-base-type 'double3 ) 'double      )
(is-error (cl-cuda.lang::vector-type-base-type 'double  ) simple-error)
(is-error (cl-cuda.lang::vector-type-base-type 'double3*) simple-error)

;; test vector-type-length
(is       (cl-cuda.lang::vector-type-length 'float3 ) 3           )
(is-error (cl-cuda.lang::vector-type-length 'float  ) simple-error)
(is-error (cl-cuda.lang::vector-type-length 'float3*) simple-error)
(is       (cl-cuda.lang::vector-type-length 'double3 ) 3           )
(is-error (cl-cuda.lang::vector-type-length 'double  ) simple-error)
(is-error (cl-cuda.lang::vector-type-length 'double3*) simple-error)

;; test vector-type-elements
(is       (cl-cuda.lang::vector-type-elements 'float3) '(cl-cuda.lang::x cl-cuda.lang::y cl-cuda.lang::z))
(is       (cl-cuda.lang::vector-type-elements 'float4) '(cl-cuda.lang::x cl-cuda.lang::y cl-cuda.lang::z cl-cuda.lang::w))
(is-error (cl-cuda.lang::vector-type-elements 'float ) simple-error)
(is-error (cl-cuda.lang::vector-type-elements 'float*) simple-error)
(is       (cl-cuda.lang::vector-type-elements 'double3) '(cl-cuda.lang::x cl-cuda.lang::y cl-cuda.lang::z))
(is       (cl-cuda.lang::vector-type-elements 'double4) '(cl-cuda.lang::x cl-cuda.lang::y cl-cuda.lang::z cl-cuda.lang::w))
(is-error (cl-cuda.lang::vector-type-elements 'double ) simple-error)
(is-error (cl-cuda.lang::vector-type-elements 'double*) simple-error)

;; test vector-type-selectors
(is       (cl-cuda.lang::vector-type-selectors 'float3) '(float3-x float3-y float3-z))
(is       (cl-cuda.lang::vector-type-selectors 'float4) '(float4-x float4-y float4-z float4-w))
(is-error (cl-cuda.lang::vector-type-selectors 'float ) simple-error)
(is-error (cl-cuda.lang::vector-type-selectors 'float*) simple-error)
(is       (cl-cuda.lang::vector-type-selectors 'double3) '(double3-x double3-y double3-z))
(is       (cl-cuda.lang::vector-type-selectors 'double4) '(double4-x double4-y double4-z double4-w))
(is-error (cl-cuda.lang::vector-type-selectors 'double ) simple-error)
(is-error (cl-cuda.lang::vector-type-selectors 'double*) simple-error)

;; test valid-vector-type-selector-p
(is (cl-cuda.lang::valid-vector-type-selector-p 'float3-x) t)
(is (cl-cuda.lang::valid-vector-type-selector-p 'float3-y) t)
(is (cl-cuda.lang::valid-vector-type-selector-p 'float3-z) t)
(is (cl-cuda.lang::valid-vector-type-selector-p 'float4-x) t)
(is (cl-cuda.lang::valid-vector-type-selector-p 'float4-y) t)
(is (cl-cuda.lang::valid-vector-type-selector-p 'float4-z) t)
(is (cl-cuda.lang::valid-vector-type-selector-p 'float4-w) t)
(is (cl-cuda.lang::valid-vector-type-selector-p 'float   ) nil)
(is (cl-cuda.lang::valid-vector-type-selector-p 'float3  ) nil)
(is (cl-cuda.lang::valid-vector-type-selector-p 'float3* ) nil)
(is (cl-cuda.lang::valid-vector-type-selector-p 'double3-x) t)
(is (cl-cuda.lang::valid-vector-type-selector-p 'double3-y) t)
(is (cl-cuda.lang::valid-vector-type-selector-p 'double3-z) t)
(is (cl-cuda.lang::valid-vector-type-selector-p 'double4-x) t)
(is (cl-cuda.lang::valid-vector-type-selector-p 'double4-y) t)
(is (cl-cuda.lang::valid-vector-type-selector-p 'double4-z) t)
(is (cl-cuda.lang::valid-vector-type-selector-p 'double4-w) t)
(is (cl-cuda.lang::valid-vector-type-selector-p 'double   ) nil)
(is (cl-cuda.lang::valid-vector-type-selector-p 'double3  ) nil)
(is (cl-cuda.lang::valid-vector-type-selector-p 'double3* ) nil)

;; test vector-type-selector-type
(is       (cl-cuda.lang::vector-type-selector-type 'float3-x) 'float3     )
(is       (cl-cuda.lang::vector-type-selector-type 'float3-y) 'float3     )
(is       (cl-cuda.lang::vector-type-selector-type 'float3-z) 'float3     )
(is       (cl-cuda.lang::vector-type-selector-type 'float4-x) 'float4     )
(is       (cl-cuda.lang::vector-type-selector-type 'float4-y) 'float4     )
(is       (cl-cuda.lang::vector-type-selector-type 'float4-z) 'float4     )
(is       (cl-cuda.lang::vector-type-selector-type 'float4-w) 'float4     )
(is-error (cl-cuda.lang::vector-type-selector-type 'float   ) simple-error)
(is       (cl-cuda.lang::vector-type-selector-type 'double3-x) 'double3     )
(is       (cl-cuda.lang::vector-type-selector-type 'double3-y) 'double3     )
(is       (cl-cuda.lang::vector-type-selector-type 'double3-z) 'double3     )
(is       (cl-cuda.lang::vector-type-selector-type 'double4-x) 'double4     )
(is       (cl-cuda.lang::vector-type-selector-type 'double4-y) 'double4     )
(is       (cl-cuda.lang::vector-type-selector-type 'double4-z) 'double4     )
(is       (cl-cuda.lang::vector-type-selector-type 'double4-w) 'double4     )
(is-error (cl-cuda.lang::vector-type-selector-type 'double   ) simple-error)

;; test array-type-p
(is (cl-cuda.lang::array-type-p 'float ) nil)
(is (cl-cuda.lang::array-type-p 'float3) nil)
(is (cl-cuda.lang::array-type-p 'float*) t  )
(is (cl-cuda.lang::array-type-p 'double ) nil)
(is (cl-cuda.lang::array-type-p 'double3) nil)
(is (cl-cuda.lang::array-type-p 'double*) t  )

;; test array-cffi-type
(is       (cl-cuda.lang::array-cffi-type 'float* ) 'cl-cuda.lang::cu-device-ptr)
(is       (cl-cuda.lang::array-cffi-type 'float3*) 'cl-cuda.lang::cu-device-ptr)
(is       (cl-cuda.lang::array-cffi-type 'float4*) 'cl-cuda.lang::cu-device-ptr)
(is-error (cl-cuda.lang::array-cffi-type 'float  ) simple-error           )
(is-error (cl-cuda.lang::array-cffi-type 'float3 ) simple-error           )
(is       (cl-cuda.lang::array-cffi-type 'double* ) 'cl-cuda.lang::cu-device-ptr)
(is       (cl-cuda.lang::array-cffi-type 'double3*) 'cl-cuda.lang::cu-device-ptr)
(is       (cl-cuda.lang::array-cffi-type 'double4*) 'cl-cuda.lang::cu-device-ptr)
(is-error (cl-cuda.lang::array-cffi-type 'double  ) simple-error           )
(is-error (cl-cuda.lang::array-cffi-type 'double3 ) simple-error           )

;; test array-type-pointer-size
(is       (cl-cuda.lang::array-type-pointer-size 'float* )
          (cffi:foreign-type-size 'cl-cuda.lang::cu-device-ptr))
(is       (cl-cuda.lang::array-type-pointer-size 'float3*)
          (cffi:foreign-type-size 'cl-cuda.lang::cu-device-ptr))
(is       (cl-cuda.lang::array-type-pointer-size 'float4*)
          (cffi:foreign-type-size 'cl-cuda.lang::cu-device-ptr))
(is-error (cl-cuda.lang::array-type-pointer-size 'float  ) simple-error)
(is-error (cl-cuda.lang::array-type-pointer-size 'float3 ) simple-error)
(is       (cl-cuda.lang::array-type-pointer-size 'double* )
          (cffi:foreign-type-size 'cl-cuda.lang::cu-device-ptr))
(is       (cl-cuda.lang::array-type-pointer-size 'double3*)
          (cffi:foreign-type-size 'cl-cuda.lang::cu-device-ptr))
(is       (cl-cuda.lang::array-type-pointer-size 'double4*)
          (cffi:foreign-type-size 'cl-cuda.lang::cu-device-ptr))
(is-error (cl-cuda.lang::array-type-pointer-size 'double  ) simple-error)
(is-error (cl-cuda.lang::array-type-pointer-size 'double3 ) simple-error)

;; test array-type-dimension
(is       (cl-cuda.lang::array-type-dimension 'int*  ) 1)
(is       (cl-cuda.lang::array-type-dimension 'int** ) 2)
(is       (cl-cuda.lang::array-type-dimension 'int***) 3)
(is-error (cl-cuda.lang::array-type-dimension 'int   ) simple-error)
(is-error (cl-cuda.lang::array-type-dimension 'int3  ) simple-error)

;; test add-star
(is (cl-cuda.lang::add-star 'int -1) 'int  )
(is (cl-cuda.lang::add-star 'int 0 ) 'int  )
(is (cl-cuda.lang::add-star 'int 1 ) 'int* )
;(is (cl-cuda.lang::add-star 'int 2 ) 'int**)

;; test remove-star
(is (cl-cuda.lang::remove-star 'int  ) 'int)
(is (cl-cuda.lang::remove-star 'int* ) 'int)
(is (cl-cuda.lang::remove-star 'int**) 'int)
