...
;; test enum-keyword
(is       (cl-cuda.driver-api::enum-keyword '(:a 1)  ) :a          )
(is       (cl-cuda.driver-api::enum-keyword :a       ) :a          )
(is-error (cl-cuda.driver-api::enum-keyword nil      ) simple-error)
(is-error (cl-cuda.driver-api::enum-keyword '(:a 1 2)) simple-error)

;; test enum-value
(is       (cl-cuda.driver-api::enum-value '(:a 1)  ) 1           )
(is-error (cl-cuda.driver-api::enum-value '(:a 1 2)) simple-error)
(is-error (cl-cuda.driver-api::enum-value :a       ) simple-error)

;; test expansion of defcuenum macro
(is-expand (cl-cuda.driver-api::defcuenum cu-event-flags-enum
             (:cu-event-default #X0)
