...
(defglobal h 0.005)
(defglobal dt 0.0004)
(defglobal pi 3.1415927)
(defglobal visc 0.2)
(defglobal limit 200.0)
(defglobal pmass (/ 0.00020543 8.0))
(defglobal radius 0.002)
(defglobal epsilon 0.00001)
(defglobal extdamp 512.0)
(defglobal simscale 0.004)
(defglobal intstiff 3.0)
(defglobal extstiff 20000.0)
(defglobal restdensity 600.0)
(defglobal g (float4 0.0 -9.8 0.0 0.0))
(defglobal box-min (float4 0.0 0.0 0.0 0.0))
(defglobal box-max (float4 0.0 0.0 0.0 0.0))
(defglobal origin (float4 0.0 0.0 0.0 0.0))
(defglobal delta 0.0)
(defglobal capacity 0)
(defglobal size-x 0)
(defglobal size-y 0)
(defglobal size-z 0)
